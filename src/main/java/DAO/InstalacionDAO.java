...
public class InstalacionDAO implements DAO<Instalacion> {
    ...
    public void insertar(Instalacion instalacion) throws SQLException {
        ...
        GestorTransaccion.ejecutar(conexion -> {
            // Crear e inicializar PreparedStatement
     ...
     * Metodo adicional para evitar conversiones innecesarias de String a Integer cuando se llame desde el controlador, se trabajará con un entero directamente
     *
